            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="noTelp" class="col-md-4 col-form-label text-md-right">{{ __('No Telphone') }}</label>
                            <div class="col-md-6">
                                <input type="text" name="noTelp" id="" class="form-control @error('noTelp') is-invalid @enderror" value="{{old('noTelp')}}">
                                @error('noTelp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
